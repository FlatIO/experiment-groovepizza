...
PizzaToFlat.prototype.convert = function () {
  ...
  if (!Array.isArray(sections) || sections.length === 0) {
     throw new Error('No pizza section in the chosen file. This usually happens when Groove Pizza did not save the file yet. Please retry in a few seconds once Groove Pizza has saved your modifications.');
  }
